...
def setup_virtual_environment():
    ...
    if os.path.exists(venv_path):
        ...
        if not run_command("~/dkenv/bin/pip install 'setuptools<81'", check=False):
    ...
    if run_command("~/dkenv/bin/pip install dagknows typing_extensions 'setuptools<81' --force-reinstall", check=False):
        ...
        print_error("You can try manually: ~/dkenv/bin/pip install dagknows typing_extensions 'setuptools<81' --force-reinstall")
        return False
